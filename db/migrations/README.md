...
- `0026` adds the newest-first Issue-ledger index and the country lookup index used by Owner OS filters without indexing decrypted customer data.
...
On 2026-08-19, migration `0026` was exercised on isolated Neon branch `owner-os-issue-index-proof-20260819` (`br-autumn-hill-axb7xq9u`) against representative Issue/shipping tables. Verification confirmed both intended Issue-ledger filter indexes. The temporary branch was deleted after verification.
