...
test('accepts only review-state private PNG artwork with enough real production pixels', () => {
...
test.each([
  ...
  [{ ...valid, artworkUrl: 'https://abc.public.blob.vercel-storage.com/issues/x.png' }, /private/i],
  [{ ...valid, artworkMimeType: 'image/jpeg' }, /png/i],
  [{ ...valid, artworkBytes: 0 }, /empty|bytes/i],
  [{ ...valid, width: 900, height: 1300 }, /resolution|dimensions/i],
  [{ ...valid, objectType: 'hat', width: 900, height: 900 }, /resolution|dimensions/i],
